...
{
    public class NaiveImplementationTests
    {
        private readonly ITestOutputHelper _output;

        public NaiveImplementationTests(ITestOutputHelper output)
        {
            _output = output;
        ...
        [Fact]
        public void OnlyCallsContructorOnceForMultipleInstanceCalls()
        {
            Assert.Null(SingletonTestHelpers.GetPrivateStaticInstance<Singleton>());
